...
HRESULT CBoard::OnCreateDevice(IDirect3DDevice9 * pd3dDevice)
{
	...
	hr = D3DXCreateEffectFromFile(pd3dDevice, _wstrFXName.c_str(), NULL, NULL, 0, NULL, &m_pEffect, &pCode);
	if (pCode)
	{
...
void CBoard::setFile(std::wstring wstrImgName, std::wstring wstrFXName)
{
