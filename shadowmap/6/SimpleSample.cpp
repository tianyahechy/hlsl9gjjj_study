...
std::wstring wstrFXName1 = L"D:\\lifei\\test\\hlsl高级精讲\\shadowmap\\6\\ResFile_1_Occluder\\filefx.fx";
                                     ...
                                     void* pUserContext )
{
	...
	strShadowModelVec = strModelNameVec;

	std::wstring wstrImgName3 = L"D:\\lifei\\test\\hlsl高级精讲\\阴影\\ResFile_Debug\\colormap.bmp";
	std::wstring wstrFXName3 = L"D:\\lifei\\test\\hlsl高级精讲\\shadowmap\\6\\ResFile_Debug\\filefx.fx";
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
	...
	D3DXMatrixOrthoLH(&g_matProjectRTT, D3DX_PI / 4, fAspectRatio, 1.0f, 1000.0f);
...
{
	//物体的观察矩阵
	D3DXVECTOR3 vEyePt(10.0 , 10, 10 );
	D3DXVECTOR3 vLookatPt(0, 0, 0);
	D3DXVECTOR3 vUpVec(0, 1, 0);
	D3DXMatrixLookAtLH(&g_matView, &vEyePt, &vLookatPt, &vUpVec);
	//设置灯光位置，照射方向
	D3DXVECTOR3 vLightEyePt(0 , 0, 530 * cos(fTime / 3.0));
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	g_OccluderObject.getTexture()->GetSurfaceLevel(0, &RTTSurface);
	...
	g_TextureDebug.OnFrameRender(pd3dDevice, g_OccluderObject.getTexture(), 0);
	pd3dDevice->EndScene();	
