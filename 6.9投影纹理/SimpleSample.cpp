                                     ...
                                     void* pUserContext )
{
	...
	lstrcat(szRcPath, L"\\ResFile_1_Reference");
	SetCurrentDirectory(szRcPath);
	TCHAR * szFile_2 = L"ShmFile.shm";
	hr = g_RenderObject.OnCreateDevice(pd3dDevice, szFile_2);
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	g_RenderObject.OnFrameMove(pd3dDevice, &g_matWorld, &g_matView, &g_matProject, fTime);
	//设置投影位置，投影目标，向上向量
	...
	pd3dDevice->Clear( 0, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DXCOLOR( 0, 0.25, 0.25, 0.55f ), 1.0f, 0 ) ;
