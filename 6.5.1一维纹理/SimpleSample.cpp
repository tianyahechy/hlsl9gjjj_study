...
//立方体纹理
CRenderObject				g_RenderObject_Light;
                                     ...
                                     void* pUserContext )
{
	...
	hr = g_RenderObject_Light.OnCreateDevice(pd3dDevice, szFile_2);
	if (FAILED(hr))
	{
		return hr;
	}
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	...
	g_RenderObject_Light.OnResetDevice();
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	//将灯光位置给受光物体
	g_RenderObject_Ground.setLightParameter(&vLightPosition);
	//将灯光位置给受光物体
	D3DXMatrixTranslation(&g_matWorld, vLightPosition.x, vLightPosition.y, vLightPosition.z);
	g_RenderObject_Light.OnFrameMove(pd3dDevice, &g_matWorld, &g_matView, &g_matProject, fTime, &vViewPosition);
	...
	g_RenderObject_Light.OnFrameRender(pd3dDevice);
...
void CALLBACK OnD3D9LostDevice( void* pUserContext )
{
	...
	g_RenderObject_Light.OnLostDevice();
}
...
void CALLBACK OnD3D9DestroyDevice( void* pUserContext )
{
	...
	g_RenderObject_Light.OnDestroyDevice();
}
