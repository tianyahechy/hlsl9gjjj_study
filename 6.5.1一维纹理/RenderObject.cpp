...
void CRenderObject::setLightParameter(D3DXVECTOR4 * pVector4)
{
	D3DXHANDLE lightPositionHandle = m_pEffect->GetParameterByName(0, "g_vLightPosition");
	m_pEffect->SetVector(lightPositionHandle, pVector4);
}
...
HRESULT CRenderObject::OnCreateDevice(IDirect3DDevice9 * pd3dDevice, TCHAR * FileName)
{
	...
	hr = D3DXCreateTextureFromFileEx(pd3dDevice, szFile, D3DX_DEFAULT, D3DX_DEFAULT,
		D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED,
		D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &m_pColorTexture);
	return hr;
}
...
void CRenderObject::OnFrameMove(IDirect3DDevice9* pd3dDevice,D3DXMATRIXA16 * pWorld, D3DXMATRIXA16 * pView, D3DXMATRIXA16 * pProject, double fTime, D3DXVECTOR4* pvEye)
{
	...
	D3DXHANDLE matNormalInverseHandle = m_pEffect->GetParameterByName(0, "g_matWorldNormalInverseTranspose");
