                                     ...
                                     void* pUserContext )
{
	...
	hr = g_RenderObject_2.OnCreateDevice(pd3dDevice, szFile_2);
	if (FAILED(hr))
	{
		return hr;
	}
	D3DXVECTOR3 vecEye(20.0f, 3.0f, 0.0f);
	D3DXVECTOR3 vecAt(0.0f, 0.0f, 0.0f);
	g_Camera.SetViewParams(&vecEye, &vecAt);
	g_Camera.SetRadius(g_RenderObject_1.GetRadius() * 2.0f, g_RenderObject_1.GetRadius() * 0.5f, g_RenderObject_1.GetRadius() * 4.0f);
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	...
	g_RenderObject_2.OnResetDevice();
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	// 观察矩阵
	g_matProject= *g_Camera.GetProjMatrix();
	g_matView = *g_Camera.GetViewMatrix();

	g_RenderObject_1.OnFrameMove(pd3dDevice, &g_matWorld, &g_matView, &g_matProject, fTime);
	g_RenderObject_2.OnFrameMove(pd3dDevice, &g_matWorld, &g_matView, &g_matProject, fTime);
