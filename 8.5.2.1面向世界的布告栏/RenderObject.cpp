...
void CRenderObject::OnFrameMove(
	...
	D3DXVECTOR3 v3LookAt)
{
	...
	//观察位置和摄像机位置
	D3DXVECTOR4 v4Eye = D3DXVECTOR4(v3Eye, 1.0);
	D3DXVECTOR4 v4LookAt = D3DXVECTOR4(v3LookAt, 1.0);
	D3DXHANDLE eyeHandle = m_pEffect->GetParameterByName(0, "g_vEyePt");
	m_pEffect->SetVector(eyeHandle, &v4Eye);
	D3DXHANDLE lookAtHandle = m_pEffect->GetParameterByName(0, "g_vLookAt");
	m_pEffect->SetVector(lookAtHandle, &v4LookAt);
}
