...
CRenderObjectCube			g_RenderObject_Cube;
CRenderObjectCube			g_RenderObject_Ball;
                                     ...
                                     void* pUserContext )
{
	...
	lstrcat(szRcPath, L"\\ResFile_1_Cube");
	SetCurrentDirectory(szRcPath);
	TCHAR * szFile_1 = L"ShmFile.shm";
	hr = g_RenderObject_Cube.OnCreateDevice(pd3dDevice, szFile_1);
	if (FAILED(hr))
	{
		return hr;
	}
	...
	hr = g_RenderObject_Ground.OnCreateDevice(pd3dDevice, szFile_2);
	if (FAILED(hr))
	{
		return hr;
	}
	...
	lstrcpy(szRcPath, szAppPath);
	lstrcat(szRcPath, L"\\ResFile_3_Ball");
	SetCurrentDirectory(szRcPath);
	TCHAR * szFile_3 = L"ShmFile.shm";
	hr = g_RenderObject_Ball.OnCreateDevice(pd3dDevice, szFile_3);
	if (FAILED(hr))
	{
		return hr;
	}
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	...
	g_RenderObject_Cube.OnResetDevice();
	g_RenderObject_Ground.OnResetDevice();
	g_RenderObject_Ball.OnResetDevice();
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	g_RenderObject_Cube.OnFrameMove(pd3dDevice, &g_matWorld, &g_matView, &g_matProject, fTime);
	...
	g_RenderObject_Cube.OnFrameRender(pd3dDevice);
...
void CALLBACK OnD3D9LostDevice( void* pUserContext )
{
	...
	g_RenderObject_Cube.OnLostDevice();
...
void CALLBACK OnD3D9DestroyDevice( void* pUserContext )
{
	...
	g_RenderObject_Cube.OnDestroyDevice();
