...
//绘制的物体
CRenderObject				g_RenderObject_1;
...
#endif
	device = pd3dDevice;
	TCHAR* szFile_1 = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\ShmFile.shm";
	TCHAR* szEffectFile_1 = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\3_2.txt";
	TCHAR* szVertexShaderFileName = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\3_2vertex.txt";
	TCHAR* szPixelShaderFileName = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\3_2Pixel.txt";
	TCHAR* szFile_ModelName = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\model.x";
	TCHAR* szFile_TextureName = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1_Ground\\colormap.jpg";
	g_RenderObject_1.setFiles(L"", szFile_ModelName, szFile_TextureName);
	g_RenderObject_1.setVertexShaderFile(szVertexShaderFileName);
	g_RenderObject_1.setPixelShaderFile(szPixelShaderFileName);
	hr = g_RenderObject_1.OnCreateDevice(pd3dDevice, szFile_1);
	if (FAILED(hr))
	{
		return hr;
	}
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	...
	g_RenderObject_1.OnResetDevice(pd3dDevice);
	//g_RenderObject_2.OnResetDevice(pd3dDevice);
...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime,  void* pUserContext)
{
	...
	g_RenderObject_1.OnFrameMove(device, &g_matWorld, &g_matView, &g_matProject, fTime);
}
