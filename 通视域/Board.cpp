...
HRESULT CBoard::OnCreateDevice(IDirect3DDevice9 * pd3dDevice)
{
	...
	TCHAR* szFile = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_Debug\\7_3_2.txt";
...
void CBoard::OnFrameRender(IDirect3DDevice9 * pd3dDevice, float fProgress)
{
	...
	D3DXHANDLE RTTTechHandle = m_pEffect->GetTechniqueByName("Default");
