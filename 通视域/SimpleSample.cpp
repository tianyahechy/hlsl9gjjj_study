                                     ...
                                     void* pUserContext )
{
	...
	TCHAR* szFile_1 = L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_1\\ShmFile.shm";
	...
	SetCurrentDirectory(L"D:\\lifei\\test\\hlsl高级精讲\\SimpleSample\\ResFile_Debug\\");
                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	D3DXMatrixPerspectiveFovLH(&g_matProject, D3DX_PI / 4, 1, 1.0f, 100.0f);
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    {
		g_RenderObject_1.OnFrameRender(pd3dDevice, g_RenderObject_1.ReturnTexture());
		//g_RenderObject_1.OnFrameRender(pd3dDevice);
		g_TextureDebug.OnFrameRender(pd3dDevice, g_RenderObject_1.ReturnTexture(), 0);
