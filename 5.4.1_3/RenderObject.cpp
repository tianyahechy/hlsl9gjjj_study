...
void CRenderObject::OnFrameMove(IDirect3DDevice9* pd3dDevice,D3DXMATRIXA16 * pWorld, D3DXMATRIXA16 * pView, D3DXMATRIXA16 * pProject, double fTime, D3DXVECTOR4* pvEye, D3DXVECTOR4* p4vLookAt)
{
	...
	D3DXHANDLE lightLookAtHandle = m_pEffect->GetParameterByName(0, "g_vLightLookAt");
	m_pEffect->SetVector(lightLookAtHandle, pvEye);
