...
CModelViewerCamera			g_Camera;				//用户摄像机
                                     ...
                                     void* pUserContext )
{
	...
	hr = g_RenderObject_Box.OnCreateDevice(pd3dDevice, szFile_2);
	if (FAILED(hr))
	{
		return hr;
	}

	D3DXVECTOR3 vecEye(10.0f, 30.0f, 0.0f);
...
{
	// 物体绕 Y 轴旋转
	D3DXMatrixRotationY(&g_matWorld, fTime / 3.0);
