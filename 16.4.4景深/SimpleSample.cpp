                                    ...
                                    const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
   ...
   // g_Camera.SetProjParams( D3DX_PI / 4, fAspectRatio, 0.1f, 1000.0f );
	...
	g_FullWindow.OnResetDevice(pd3dDevice, pBackBufferSurfaceDesc);
	g_TextureDebug.OnResetDevice(pd3dDevice, pBackBufferSurfaceDesc);
...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	// 观察矩阵
	D3DXVECTOR3 g_vEyePt(25 * sin(fTime / 3.0), 17, 30 * cos(fTime / 3.0));
	...
	//{
		g_RenderObject_Ground.RenderToTexture(pd3dDevice, g_vEyePt, fTime);
	//}
	//DXUT_EndPerfEvent();
    ...
    {
		//DXUT_BeginPerfEvent(D3DCOLOR_XRGB(0, 255, 0), L"DisplayRTT");
		//{
			g_TextureDebug.OnFrameRender(pd3dDevice, g_RenderObject_Ground.returnTexture(), 1);
		//}
		//DXUT_EndPerfEvent();
		//DXUT_BeginPerfEvent(D3DCOLOR_XRGB(0, 255, 0), L"DepthOfField");
		//{
